...
public class AreaActivity extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        save_btn.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                String fromUnit = autoCompleteTextView_from.getText().toString();
                String toUnit = autoCompleteTextView_to.getText().toString();
                String input = outlinedTextField_area_unit.getText().toString();
                String result = area_output_text.getText().toString();

                if (fromUnit.isEmpty() || toUnit.isEmpty() || input.isEmpty() || result.isEmpty()) {
                    Toast.makeText(AreaActivity.this, "Make sure you've done a conversion first!", Toast.LENGTH_SHORT).show();
                    return;
                }
    ...
    private void saveConversionToDatabase(String fromUnit, String toUnit, String input, String result) {
        DBHelper dbHelper = new DBHelper(AreaActivity.this);
        boolean isInserted = dbHelper.insertAreaConversion(fromUnit, toUnit, input, result);

        if (isInserted) {
            Toast.makeText(AreaActivity.this, "Conversion saved!", Toast.LENGTH_SHORT).show();
        } else {
            Toast.makeText(AreaActivity.this, "Error saving conversion.", Toast.LENGTH_SHORT).show();
        }
    }
