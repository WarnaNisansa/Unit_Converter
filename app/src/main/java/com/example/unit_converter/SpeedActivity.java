...
public class SpeedActivity extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        Button save_btn = findViewById(R.id.button_save_speed);
        ...
        save_btn.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                String fromUnit = autoCompleteTextView_from.getText().toString();
                String toUnit = autoCompleteTextView_to.getText().toString();
                String input = outlinedTextField_speed_unit.getText().toString();
                String result = speed_output_text.getText().toString();

                if (fromUnit.isEmpty() || toUnit.isEmpty() || input.isEmpty() || result.isEmpty()) {
                    Toast.makeText(SpeedActivity.this, "Make sure you've done a conversion first!", Toast.LENGTH_SHORT).show();
                    return;
                }
    ...
    private void saveConversionToDatabase(String fromUnit, String toUnit, String input, String result) {
        DBHelper dbHelper = new DBHelper(SpeedActivity.this);
        boolean isInserted = dbHelper.insertSpeedConversion(fromUnit, toUnit, input, result);

        if (isInserted) {
            Toast.makeText(SpeedActivity.this, "Conversion saved!", Toast.LENGTH_SHORT).show();
        } else {
            Toast.makeText(SpeedActivity.this, "Error saving conversion.", Toast.LENGTH_SHORT).show();
        }
    }
